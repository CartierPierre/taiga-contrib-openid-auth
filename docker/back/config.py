...
if ENABLE_OPENID:
    ...
    OPENID_ID_FIELD = os.getenv('OPENID_ID_FIELD')
    OPENID_USERNAME_FIELD = os.getenv('OPENID_USERNAME_FIELD')
    OPENID_FULLNAME_FIELD = os.getenv('OPENID_FULLNAME_FIELD')
    OPENID_EMAIL_FIELD = os.getenv('OPENID_EMAIL_FIELD')
